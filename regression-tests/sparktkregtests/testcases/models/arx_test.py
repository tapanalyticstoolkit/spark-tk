...
class ArxTest(sparktk_test.SparkTKTestCase):
    def setUp(self):
        ...
        self.frame = self.context.frame.import_csv(
            dataset, schema=schema, delimiter=",", header=False)
        self.assertEqual(
            500000, self.frame.count(),
            msg="Dataframe created incorrectly. Check dataset for infinite")
    ...
    def test_arx_train(self):
        ...
        self.assertAlmostEqual(
            model.coefficients[4], -0.04275, delta=0.00000001)
